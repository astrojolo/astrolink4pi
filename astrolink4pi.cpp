...
IPState AstroLink4Pi::MoveAbsFocuser(uint32_t targetTicks)
{
	...
	_abort = false;
	_motionThread = thread_object(&AstroLink4Pi::motorThread, targetTicks, lastDirection, pigpioHandle, backlashTicksRemaining);
...
void AstroLink4Pi::motorThread[this](uint32_t targetPos, int direction, int pigpioHandle, int backlashTicksRemaining)
{
	int motorDirection = direction;
