...
AstroLink4Pi::AstroLink4Pi() : FI(this), WI(this), m_PwmController(m_BoardIO), m_PowerMonitor(ADS_ADDR, ACS_TYPE, getDeviceName())
{
...
{
	PowerMonitor::Readings r;

	if (!m_PowerMonitor.read(r))
	{
